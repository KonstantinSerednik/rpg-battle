...
export const ALL_ATTACKS: Attack[] = [
  ...
  { name: "Снайперский выстрел", damage: 25, uses: 2, max_uses: 2, className: "Лучник", energyGain: 35 },
  ...
  // === ПАЛАДИН (Праведность) ===
  { name: "Молот праведника", damage: 20, uses: 3, max_uses: 3, className: "Паладин", energyGain: 22 },
  ...
  { name: "Освящение", damage: -18, uses: 3, max_uses: 3, className: "Паладин", energyGain: 25, appliedEffects: [{ ...EFFECTS.SHIELD, shieldAmount: 15 }], effectChance: 1.0 },
  { name: "Священный молот", damage: 30, uses: 2, max_uses: 2, className: "Паладин", energyGain: 25 },
  { name: "Искупление", damage: -25, uses: 3, max_uses: 3, className: "Паладин", energyGain: 25, appliedEffects: [{ ...EFFECTS.REFLECT, duration: 1 }], effectChance: 1.0 },
  ...
  { name: "Токсичный газ", damage: 15, uses: 5, max_uses: 5, className: "Алхимик", energyGain: 20, appliedEffects: [EFFECTS.CORROSION], effectChance: 0.7 },
  { name: "Взрывная смесь", damage: 23, uses: 4, max_uses: 4, className: "Алхимик", energyGain: 20, appliedEffects: [EFFECTS.CORROSION], effectChance: 0.5 },
  ...
  { name: "Альбедо", damage: -100, uses: 1, max_uses: 1, className: "Алхимик", isUltimate: true, energyCost: 70, appliedEffects: [EFFECTS.PROTECTION], effectChance: 1.0 },
  { name: "Цитринитас", damage: 50, uses: 1, max_uses: 1, className: "Алхимик", isUltimate: true, energyCost: 50, appliedEffects: [EFFECTS.REGENERATION], effectChance: 1.0 },
